...
(function() {
	...
	app.controller("LivrariaController", function($scope) {
		...
		$scope.editBook = function(mtitle, mauthors, mdescription, mphoto, mprice) {
			$scope.book = {title: mtitle, authors: mauthors, description: mdescription, photo: mphoto, price: mprice, comments: $scope.book.comments};
		};
